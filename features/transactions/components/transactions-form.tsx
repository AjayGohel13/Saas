...
export const TransactionsForm = ({ id, defaultValues, onSubmit, onDelete, disabled, accountOptions, onCreateAccount, onCreateCategory, categoryOptions }: props) => {
    ...
    return (
        <Form {...form} >
            <form onSubmit={form.handleSubmit(handleSubmit)} className=" space-y-4 pt-4 ">
                ...
                {!!id && <Button type="button" disabled={disabled} onClick={handleDelete} variant='outline' className=" w-full ">
