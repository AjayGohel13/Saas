...
const SEED_USER_ID = "user_2i0wgYi9wmCRGZ1X25ApjEbFZMM"
...
const defaltFrom = subDays(defaultTo,90)
...
const generateTransactions = () => {
    const days = eachDayOfInterval({ start: defaltFrom, end: defaultTo })
